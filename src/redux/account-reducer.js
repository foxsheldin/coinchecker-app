        ...
        case "cash":
          return {
            ...
            accountsInfo: {
              ...state.accountsInfo,
              cashData: [
                ...state.accountsInfo.cashData,
                action.data.newAccount,
              ],
            },
          };
        case "card":
        ...
        case "bankAccount":
          return {
            ...
            accountsInfo: {
              ...state.accountsInfo,
              bankAccountData: [
                ...state.accountsInfo.bankAccountData,
                action.data.newAccount,
              ],
            },
          };
        case "deposit":
          return {
            ...
            accountsInfo: {
              ...state.accountsInfo,
              depositData: [
                ...state.accountsInfo.depositData,
                action.data.newAccount,
              ],
            },
          };
...
const setAccountsInfo = (accountsInfo) => ({
...
const setBalanceForChart = (balanceDatasets) => ({
  type: SET_BALANCE_FOR_CHART,
  balanceDatasets,
});
