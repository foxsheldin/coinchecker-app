    ...
    <div className="App">
      <Routes>
        ...
        <Route path="system" element={<SystemLayout />}>
          ...
          <Route
            path="/system/transaction/:page"
            element={<TransactionPage />}
          />
          <Route
            path="/system/transaction/filter/:typeAccount/:accountID/:page"
            element={<TransactionPage />}
          />
          <Route
            path="/system/transaction/edit/:transactionid"
          ...
          <Route
            path="/system/accounts/edit/:typeAccount/:accountID"
