  ...
  return (
    <div className="list-group-item">
      <div className="row">
        ...
        <div className="amount col-4 text-center fs-6">
        ...
        <div className="col-4">
          ...
          <a
            ...
            onClick={() =>
              props.deleteBtnOnClick(props.typeAccount, props.AccountId)
            }
          >
            Удалить
          </a>
  ...
  return (
    <div>
      <div className="container">
        <div className="row">
          <div className="col-lg-8 order-2 order-sm-2 order-lg-1">
          ...
          <div className="col-lg-4 my-3 order-1 order-sm-1 order-lg-2">
            <div className="allMoney border-start border-end">
              <div className="text mx-2 fs-5">Всего средств</div>
            ...
            <div className="addAction my-4">
              <h5>Добавить</h5>
              <button
                className="btn my-1 btn-outline-primary my-2"
