                            ...
                            <form onSubmit={props.handleSubmit}>
                                <div className="modal-body">
                                    ...
                                    <div class="form-check">
                                        ...
                                        />
                                        <label class="form-check-label" for="capitalizationOfInterest">Проценты прибавляются к сумме депозита (капитализируются)</label>
                                    </div>
                                    <div className="form-check">
                                        <Field
                                            ...
                                            className='form-check-input'
                                        />
                                        <label className="form-check-label" htmlFor="addTransaction">Создать транзакции с начислением процентов</label>
                                    </div>
                                </div>
