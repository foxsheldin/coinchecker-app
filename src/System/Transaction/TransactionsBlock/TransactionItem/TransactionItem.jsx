...
const TransactionItem = (props) => {
  ...
  if (props.isTransfer) {
        ...
        <div className="transactionDatas row my-1">
          ...
          <div className="action col-12">
            <div className="act1 row">
              ...
              <a
                className="delete col-3"
                onClick={() =>
                  props.onDeleteTransactionClick(props.transactionID)
                }
              >
                Удалить
              </a>
    ...
    if (props.isIncome) colorBalance = "green";
    else if (props.isOutcome) colorBalance = "red";
    ...
    return (
      <div className="transaction" id={"transaction_" + props.transactionID}>
        <div className="transactionDatas row my-1">
          ...
          <div className="balance col-2" style={{ color: colorBalance }}>
            {numberWithSpaces(props.amountMoney)}&nbsp;руб.
          </div>
