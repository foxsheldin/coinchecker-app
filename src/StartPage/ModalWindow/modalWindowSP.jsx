...
const ModalWindowSP = () => {
    return (
        <div>
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="addNewUserLabel">Регистрация</h5>
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form action="php/registration.php" method="POST">
                            <div className="modal-body">
                                <label for="username">Ваше имя:</label>
                                <input type="text" className="form-control" name="username" placeholder="Имя" required />
                                ...
                                <input type="password" className="form-control" name="re-password" placeholder="Подтверждение пароля" required />
                            </div>
            ...
            <div className="modal fade" id="addNewUserSucess" tabIndex="-1" aria-labelledby="addNewUserSucessLabel" aria-hidden="true">
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="addNewUserSucessLabel">Успешная регистрация</h5>
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div className="modal-body">
                            <span className="fs-6">Вы успешно зарегистрировались в системе!</span>
                        </div>
                        <div className="modal-footer">
